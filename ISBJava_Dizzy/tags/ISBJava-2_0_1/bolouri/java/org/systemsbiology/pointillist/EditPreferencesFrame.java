...
public class EditPreferencesFrame extends JFrame
{
    ...
    public EditPreferencesFrame(App pApp)
    {
    ...
    private void initialize()
    {
        ...
        Font boldFont = matlabLabel.getFont();
        Font plainFont = boldFont.deriveFont(Font.PLAIN);
        matlabLabel.setFont(plainFont);
        ...
        delimiterLabel.setFont(plainFont);
        constraints.fill = GridBagConstraints.NONE;
        constraints.gridwidth = 1;
        constraints.gridheight = 1;
        constraints.weightx = 0;
        ...
        missingDataLabel.setFont(plainFont);
        ...
        missingDataExplanationLabel.setFont(plainFont);
        ...
        matlabScriptsLocationLabel.setFont(plainFont);
        ...
        pvalueCutoffExpl.setFont(plainFont);
        ...
        this.setContentPane(prefsPanel);
        this.pack();
