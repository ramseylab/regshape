 ...
 * expressions involving <b>symbols</b>, <b>functions</b>, 
 ...
 */
public class MathExpression implements Cloneable
{
    /*========================================*
     * constants
     *========================================*/
     ...
     * is an {@link MathExpression.Element} pointed to by the <code>mFirstOperand</code>
     ...
     *
     * For a list of element codes, refer to the {@link MathExpression} class.
     */
    class Element implements Cloneable
    {
         ...
         * an {@link MathExpression.Element}.  This field should be <code>null</code>
         ...
         * an {@link MathExpression.Element}.  For a unary operation element or
        ...
        public Object clone()
        {
            ...
            newElement.mValue = mValue;
            newElement.mSymbolName = mSymbolName;
    ...
    public MathExpression(String pExpression) throws IllegalArgumentException
    {
        initialize();
    ...
    private Element convertTokenToElement(Token pToken) throws IllegalArgumentException
    {
        ...
        else
        {
            ...
            if(tokCode == TokenCode.NUMBER)
            {
                ...
                retVal.mValue = pToken.mValue;
            }
            else
            {
                retVal.mCode = ElementCode.SYMBOL;
                retVal.mSymbolName = pToken.mSymbolName;
            }
        }
        return(retVal);
    }
    ...
    private double valueOfSubtree(Element pElement, ISymbolDoubleMap pSymbolValueMap) throws DataNotFoundException
    {
        ...
        {
            valueOfSubtree = pElement.mValue;
        }
        else if(elementCode == ElementCode.SYMBOL)
        {
            String symbolName = pElement.mSymbolName;
            if(null == symbolName)
            {
                throw new IllegalArgumentException("found an element in the tree with element code ElementCode.SYMBOL, but with a null symbol name object");
            }
            // the value of the element is the value of the symbol
            valueOfSubtree = pSymbolValueMap.getValue(symbolName);
        }
        else
        {
     ...
     *========================================*/
   /**
     * Returns an {@link MathExpression.Element} which is the root of a tree of 
     ...
     * The parse tree is not stored in the <code>MathExpression</code> object.
     *
     * @param pExpressionString the string definition of the mathematical
     * expression to be parsed
     *
     * @return an {@link MathExpression.Element} which is the root of a tree of 
     * <code>Element</code> objects representing the parse tree for
     * a mathematical expression defined by the string <code>pExpressionString</code>.
     */
    ...
    static public boolean isValidSymbol(String pToken)
    {
        ...
        try
        {
            MathExpression testExp = new MathExpression(pToken);
     ...
     * this <code>MathExpression</code> object.  This method can be
     * called even if the <code>MathExpression</code> object was 
     ...
     * using the symbol values defined in the map <code>ISymbolDoubleMap</code>.
     */
    public double computeValue(ISymbolDoubleMap pSymbolValueMap) throws DataNotFoundException
    {
        Element rootElement = getRootElement();
        if(null == rootElement)
        {
    ...
    public Object clone()
    {
        ...
        {
            newMathExpression.mRootElement = (Element) mRootElement.clone();
        }
        else
        {
            newMathExpression.mRootElement = null;
        }
