...
public class DataSelector extends JFrame
{
    ...
    public DataSelector(String pTitle, MatrixString pMatrixString) throws InvalidInputException
    {
        super(pTitle);
    ...
    private static DataSelector constructDataSelector(File pFile, String pDelimiter) throws IOException, InvalidInputException
    {
        ...
        DataSelector dataSelector = new DataSelector("Please select the data columns you wish to retain", matString);
    ...
    {
        File outputFile = queryOutputFile();
        if(null != outputFile)
        {
            try
            {
    ...
    public static final void main(String []pArgs)
    {
        try
        {
            ...
            if(null != file)
            {
                DataSelector dataSelector = constructDataSelector(file, DEFAULT_DELIMITER);
